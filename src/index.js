...
export default class ThreeJSInputFields
{
    constructor(attributes)
    {   
        this.inputTypesEnabled =  { 'text': 1 }
        this.inputsLoaded = {}
        this.focusedElement =  ''
        ...
        Mousetrap.bind( 'shift',        this.shiftPress, 'keypress' );
        Mousetrap.bind( 'shift',        this.shiftRelease, 'keyup' );

        Mousetrap.bind( 'left',         this.cursorDisplace );
        Mousetrap.bind( 'right',        this.cursorDisplace );
        Mousetrap.bind( 'backspace',    this.inputBackspace );
        Mousetrap.bind( 'del',          this.inputDel );
        Mousetrap.bind( 'end',          this.inputCursorEnd );
        Mousetrap.bind( 'home',          this.inputCursorStart );
    ...
    create( type, inputId, orthographicView, params) {
        ...
        switch( this.inputTypesEnabled[ type ] )
        {
            case this.inputTypesEnabled.text :
                ...
                var newElement = new InputText( { id: inputId, inputManager: this, orthographicView: orthographicView }, params );
    ...
    getInside3DEnviromentInputs() {
        ...
        for( let index in this.inputsLoaded ) {
