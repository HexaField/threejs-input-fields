...
export default class InputField
{
    ...
    {   
        ...
        this.inputPosition = { x: 0, y: 0, z: 0 }
        ...
        this.onBlurParameters = { owner: '', callback: '', parameters: '' }
        this.onFocusParameters = { owner: '', callback: '', parameters: '' }
    ...
    setPosition( position ) {
        ...
        if( this.orthographicView ) {
            ...
            var positionExists = position === POSITIONS.POSITION_TOP_LEFT;
            positionExists = positionExists || position === POSITIONS.POSITION_TOP_RIGHT;
            positionExists = positionExists || position === POSITIONS.POSITION_BOTTOM_LEFT;
            positionExists = positionExists || position === POSITIONS.POSITION_BOTTOM_RIGHT;
            positionExists = positionExists || position === POSITIONS.POSITION_CENTER;
            positionExists = positionExists || position === POSITIONS.POSITION_TOP_CENTER;
            positionExists = positionExists || position === POSITIONS.POSITION_RIGHT_CENTER;
            positionExists = positionExists || position === POSITIONS.POSITION_BOTTOM_CENTER;
            positionExists = positionExists || position === POSITIONS.POSITION_LEFT_CENTER;
    ...
    calculateOfsetCoordinatesByPosition() {
        ...
        if( this.orthographicView ) {
            ...
            if( this.position == POSITIONS.POSITION_BOTTOM_RIGHT ||
                this.position == POSITIONS.POSITION_TOP_RIGHT ||
                this.position == POSITIONS.POSITION_RIGHT_CENTER ) {
                offsetXDirection = -1;
            }
            if( this.position == POSITIONS.POSITION_BOTTOM_LEFT ||
                this.position == POSITIONS.POSITION_BOTTOM_RIGHT ||
                this.position == POSITIONS.POSITION_BOTTOM_CENTER ) {
                offsetYDirection = -1;
            }

            if( this.position == POSITIONS.POSITION_TOP_LEFT ||
                this.position == POSITIONS.POSITION_TOP_RIGHT ||
                this.position == POSITIONS.POSITION_TOP_CENTER ) {
            ...
            if( this.position == POSITIONS.POSITION_TOP_LEFT ||
                this.position == POSITIONS.POSITION_BOTTOM_LEFT ||
                this.position == POSITIONS.POSITION_LEFT_CENTER ) {
                offset.x = ( offsetXDirection * offset.x ) + this.canvas.width / 2;
            }

            if( this.position == POSITIONS.POSITION_TOP_RIGHT ||
                this.position == POSITIONS.POSITION_BOTTOM_RIGHT ||
                this.position == POSITIONS.POSITION_RIGHT_CENTER ) {
            ...
            if( this.position == POSITIONS.POSITION_CENTER ) {
                offset.x +=  this.getCanvasWidth() * 0.5;
                offset.y +=  this.getCanvasHeight() * 0.5;
            }

            if( this.position == POSITIONS.POSITION_TOP_CENTER ||
                this.position == POSITIONS.POSITION_BOTTOM_CENTER ) {
                offset.x +=  this.getCanvasWidth() * 0.5;
            }
            if( this.position == POSITIONS.POSITION_RIGHT_CENTER ||
                this.position == POSITIONS.POSITION_LEFT_CENTER ) {
                offset.y +=  this.getCanvasHeight() * 0.5;
            }
